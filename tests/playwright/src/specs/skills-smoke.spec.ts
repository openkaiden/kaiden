...
test.describe.serial('Skills page - manual creation', { tag: '@smoke' }, () => {
...
test.describe.serial('Skills page - file import', { tag: '@smoke' }, () => {
...
test.describe.serial('Skills page - skill details', { tag: '@smoke' }, () => {
