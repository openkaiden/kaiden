...
test.describe.serial('Chat message generation control', { tag: '@smoke' }, () => {
...
test.describe.serial('Chat background streaming', { tag: '@smoke' }, () => {
...
test.describe.serial('Chat integrations', { tag: '@smoke' }, () => {
